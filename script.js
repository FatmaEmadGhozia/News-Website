document.addEventListener("DOMContentLoaded", function () {
  ...
  if (searchBtn) {
    searchBtn.addEventListener("click", function () {
      ...
      let toDate = document.querySelector(".to-date").value + 1;
...
console.log(data);
  ...
  document.querySelector('.post1 img').src=data.articles[8].image;
...
console.log(data);
  ...
  document.querySelector('.foot1 img').src=data.articles[8].image;
